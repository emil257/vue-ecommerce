<template>
  <div class="container my-5 py-5 z-depth-1" v-if="product !== null">
    <!--Section: Content-->
          ...
          >
            ...
            <div class="carousel-inner text-center text-md-left" role="listbox">
              <div class="carousel-item active">
                <img :src="product.image" alt="Third slide" class="img-fluid" />
              </div>
            </div>
            <!--/.Slides-->
          ...
          >
            ...
            <div class="card">
              ...
              <div
                ...
                data-parent="#accordionEx"
              >
                <div class="card-body">{{product.desc}}</div>
              </div>
            </div>
            <!-- Accordion card -->
            ...
            <div class="mt-5">
              <div class="row mt-3">
                <div class="col-md-12 text-center text-md-left text-md-right">
                  <button class="btn btn-primary btn-rounded" v-on:click="addItem(product)">
...
export default {
  ...
  props: ["id"],
  methods: {
    ...mapActions(["getItemById", "addItem"])
  },
  created() {
    try {
